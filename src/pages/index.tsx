...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Vintage Rare Item v1`}</title>

        <meta
          name="description"
          content="Welcome to Vintage Rare Item v1 - Your ultimate marketplace for trading vintage game items. Unleash the gamer in you with our unique collection."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Vintage Rare Item v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Vintage Rare Item v1 - Your ultimate marketplace for trading vintage game items. Unleash the gamer in you with our unique collection.`}
            </Text>
            <Box
